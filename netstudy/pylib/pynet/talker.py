...
def get_l3_l4_bitalker_gene_generators(genes_dir, bitalkers, bitalker_ids, l4_protocol=None):
    ...
    def calculate_l3_l4_bitalker_genes(genes_dir, bitalkers, bitalker_ids, l4_protocol=None):
        ...
        for bitalker_id in bitalker_ids:
            ...
            # -----------------------
            bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations = list()
            ...
            bitalker_eth_ipv4_tcp_biflow_connections_redropped = list()
            ...
            while curr_biflow_index < bitalker_any_n_biflows:
                ...
                if l4_protocol:
                    ...
                    if l4_protocol == "TCP":
                        # get initiation type
                        curr_biflow_eth_ipv4_tcp_initiation_requested_connection = int(curr_biflow[126])
                        curr_biflow_eth_ipv4_tcp_initiation_two_way_handshake = int(curr_biflow[127])
                        curr_biflow_eth_ipv4_tcp_initiation_three_way_handshake = int(curr_biflow[128])

                        # get connection type
                        curr_biflow_eth_ipv4_tcp_connection_redropped = int(curr_biflow[129])
                        curr_biflow_eth_ipv4_tcp_connection_rejected = int(curr_biflow[130])
                        curr_biflow_eth_ipv4_tcp_connection_established_half_duplex = int(curr_biflow[131])
                        curr_biflow_eth_ipv4_tcp_connection_established_full_duplex = int(curr_biflow[132])
                        
                        # get termination type
                        curr_biflow_eth_ipv4_tcp_termination_abort = int(curr_biflow[133])
                        curr_biflow_eth_ipv4_tcp_termination_null = int(curr_biflow[134])
                        curr_biflow_eth_ipv4_tcp_termination_graceful = int(curr_biflow[135])

                        # save initiation type
                        bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations.append(curr_biflow_eth_ipv4_tcp_initiation_requested_connection)
                        ...
                        bitalker_eth_ipv4_tcp_biflow_connections_redropped.append(curr_biflow_eth_ipv4_tcp_connection_redropped)
                        ...
                        bitalker_eth_ipv4_tcp_biflow_abort_terminations.append(curr_biflow_eth_ipv4_tcp_termination_abort)
                        bitalker_eth_ipv4_tcp_biflow_null_terminations.append(curr_biflow_eth_ipv4_tcp_termination_null)
                        bitalker_eth_ipv4_tcp_biflow_graceful_terminations.append(curr_biflow_eth_ipv4_tcp_termination_graceful)
            ...
            if l4_protocol:
                ...
                if l4_protocol == "TCP":
                    ...
                    # ---------------------------
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_total = round(sum(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_mean = round(np.mean(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_std = round(np.std(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_var = round(np.var(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_max = round(max(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations_min = round(min(bitalker_eth_ipv4_tcp_biflow_requested_dropped_connection_initiations), 3)
                    ...
                    # ---------------------------
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_total = round(sum(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_mean = round(np.mean(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_std = round(np.std(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_var = round(np.var(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_max = round(max(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
                    bitalker_eth_ipv4_tcp_biflow_connections_redropped_min = round(min(bitalker_eth_ipv4_tcp_biflow_connections_redropped), 3)
