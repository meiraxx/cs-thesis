...
oparser.add_argument("netgenes_path", metavar="NetGenes-Path", nargs="?", help="Input NetGenes path", default="")
...
# MAIN
netgenes_dir = os.path.dirname(args.netgenes_path)
netgenes_filename = os.path.basename(args.netgenes_path)
...
curr_dname = "s6-netgenes-data-stats" + os.sep + flows_fname.rsplit("-ipv4")[0]
mkdir_p(curr_dname)
