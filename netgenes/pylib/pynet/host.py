...
def get_l3_l4_unihost_gene_generators(genes_dir, udp_unihosts, udp_unihost_ids, tcp_unihosts, tcp_unihost_ids):
    ...
    ipv4_udp_unihost_genes_generator = calculate_l3_l4_unihost_genes(genes_dir, udp_unihosts, udp_unihost_ids, "UDP")
    ipv4_tcp_unihost_genes_generator = calculate_l3_l4_unihost_genes(genes_dir, tcp_unihosts, tcp_unihost_ids, "TCP")
